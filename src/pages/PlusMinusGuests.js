...
export default function PlusMinusGuests() {
  ...
  const { addGuests } = useContext(BookingContext);
  ...
  const incrButtonEnableDisable = (param) => {
    ...
    } else return totalGuests < guest.maxValue ? false : true;
  };
          ...
          <div className="container">
            ...
            <div className="plusMinusWrapper">
              ...
              <div className="buttons-right">
                <button
                  onClick={() => buttonHandler(0, "decr")}
                  disabled={decrButtonEnableDisable(0)}
                  style={
                    decrButtonEnableDisable(0)
                      ? styles.notAllowed
                      : styles.regular
                  }
                >
                ...
                <button
                  onClick={() => buttonHandler(0, "incr")}
                  disabled={incrButtonEnableDisable(0)}
                  style={
                    incrButtonEnableDisable(0)
                      ? styles.notAllowed
                      : styles.regular
                  }
                >
              ...
              <div className="buttons-right">
                <button
                  onClick={() => buttonHandler(1, "decr")}
                  disabled={decrButtonEnableDisable(1)}
                  style={
                    decrButtonEnableDisable(1)
                      ? styles.notAllowed
                      : styles.regular
                  }
                >
                ...
                <button
                  onClick={() => buttonHandler(1, "incr")}
                  disabled={incrButtonEnableDisable(1)}
                  style={
                    incrButtonEnableDisable(1)
                      ? styles.notAllowed
                      : styles.regular
                  }
                >
              ...
              <div className="buttons-right">
                <button
                  onClick={() => buttonHandler(2, "decr")}
                  disabled={decrButtonEnableDisable(2)}
                  style={
                    decrButtonEnableDisable(2)
                      ? styles.notAllowed
                      : styles.regular
                  }
                >
                ...
                <button
                  onClick={() => buttonHandler(2, "incr")}
                  disabled={incrButtonEnableDisable(2)}
                  style={
                    incrButtonEnableDisable(2)
                      ? styles.notAllowed
                      : styles.regular
                  }
                >
            ...
            <div className="content-under">
              <p>{apartment.maxGuests} guests maximum. </p>
              <p>
                Infants don't count towards the the number of guests, but could
                affect final price.{" "}
              </p>
              <button id="cancel">Cancel</button>
              <button id="save" onClick={saveGuests}>
                Save
              </button>
            </div>
          </div>
